      ...
      <footer className="flex gap-2 mt-2">
       ...
       />
        ...
        <button
          ...
          className="pg-2 h-10 w-full bg-brand-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm hover:bg-brand-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disable:opacity-50 disable:hover:bg-brand-500"        
          >
            Enviar feedback
        </button>
      </footer>
